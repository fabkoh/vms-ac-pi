...
def main():
    ...
    processedIP = (get_host_ip().split(".", 1)[0] + "." +
                   get_host_ip().split(".", 2)[1] + "." +
                   get_host_ip().split(".", 3)[2] + ".250")
...
while True:
    try:
        ...
        pass
# os.system('nohup java -jar -Dspring.profiles.active=production /home/etlas/vms-ac-backend-0.0.1-SNAPSHOT.jar &')
