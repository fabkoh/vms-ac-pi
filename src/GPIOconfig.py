...
def test_buzz():
   ...
   pi.write(E2_IN_Buzz, 1)  # Turn on the buzzer connected to E2_IN_Buzz
   pi.write(E2_OUT_Buzz, 1)  # Turn on the buzzer connected to E2_OUT_Buzz
   time.sleep(10)  # Keep the buzzers on for 10 seconds
   pi.write(E2_IN_Buzz, 0)  # Turn off the buzzer connected to E2_IN_Buzz
   pi.write(E2_OUT_Buzz, 0)  # Turn off the buzzer connected to E2_OUT_Buzz
